...
namespace Data {
   ...
   public static class Hub {
      ...
      /// <summary>
      /// Fired when new level is been generated.
      /// Subscribe and create whatever is needed for the level.
      /// </summary>
      /// <remarks>Fired before LevelGenerationCompleted</remarks>
      public static readonly Subject<LevelData> GenerateLevel = new Subject<LevelData>();
      ...
      /// </summary>
      public static readonly Subject<float> LevelProgressChanged = new Subject<float>();
